  ...
  return (
    <section>
      <div className="py-[80px] relative">
        {/* <Link href="/cardapp"> */}
          <div className="px-6 md:px-0 md:mx-auto lg:max-w-[325px] shadow-lg rounded-sm w-full cursor-pointer" onClick={handleCheckmarkClick}>
            <div className="relative">
              {/* Checkmark */}
              <div
                className={`absolute top-1 right-1 p-1 cursor-pointer transition-opacity duration-300 ${isChecked ? 'text-blue-500 opacity-100' : 'text-gray-400 opacity-0'}`}
              >
                <svg
