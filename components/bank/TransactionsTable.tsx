      ...
      <>
        <Table>
          <TableHeader className="bg-[#fffcfc]">
            <TableRow>
              <TableHead className="px-2 border-b-[2px] border-black-2 text-blue-900">
                Date <span className="text-blue-900 text-sm">↓</span>
              </TableHead>
          ...
          <TableBody>
            {transactions.map((t) => {
              ...
              return (
                <TableRow
                  key={t.id}
                  className={`${isDebit || amount[0] === '-' ? 'bg-[#ffffff]' : 'bg-[#ffffff]'} !over:bg-none !border-b-DEFAULT hover:bg-[#fffcfc] cursor-pointer`}
                ...
                >
                  ...
                  <TableCell
                    className={`pl-2 pr-10 font-smallbold ${isDebit || amount[0] === '$' ? 'text-[#242424]' : 'text-transparent pointer-events-none select-none'}`}
                    style={{ width: '225px' }}
                  >
                  ...
                  <TableCell
                    className={`pl-2 pr-10 font-smallbold ${isCredit || amount[0] === '-' ? 'text-[#097b24]' : 'text-transparent pointer-events-none select-none'}`}
                    style={{ width: '225px' }}
                  >
