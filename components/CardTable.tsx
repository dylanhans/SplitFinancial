...
const CardTable = () => {
  return (
    <div className="w-full rounded-lg">
      ...
      <ResizablePanelGroup direction="horizontal" className="flex w-full bg-[#f3f4f5] p-1.5 border-t border-b border-gray-200" style={{ height: '135px' }}>
        ...
        <ResizablePanel defaultSize={10} style={{ height: '100%' }}>
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <div className="flex h-full items-center justify-center p-6 border-t border-gray-200">
      ...
      <ResizablePanelGroup direction="horizontal" className="flex w-full mt-3 bg-white">
        ...
        <ResizableHandle />
        <ResizablePanel defaultSize={15} className="custom-border-left border-gray-200">
          <div className="flex h-[150px] items-center justify-center p-6">
