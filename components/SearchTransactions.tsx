...
const SearchTransactions = () => {
  return (
    <div className="border border-gray-400 rounded-sm mt-2 mb-1">
      <div className="flex items-center">
        <Command className="flex-grow">
          <CommandInput className="flex-grow h-9" placeholder="Search by keyword" />
          <CommandList>
            {/* Your command list items */}
          </CommandList>
        </Command>
        <div className="search-button ml-2">
          <Button className="h-10 w-20 border border-blue-900 rounded-none bg-blue-900">
