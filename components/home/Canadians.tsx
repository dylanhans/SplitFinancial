  ...
  return (
    ...
    >
      ...
      <div className="flex max-w-full flex-col items-center justify-center px-[30px] text-center lg:w-[500px] lg:items-start lg:text-left">
        <span className="text-3xl leading-10 md:text-4xl font-semibold not-italic mb-[12px]">
          Join 1 million+ Canadians using Neo
        </span>
        <span className="text-base leading-7 md:text-lg font-normal not-italic">
          Canadians are choosing Neo to make their lives and finances easier.
        </span>
        <div className="mt-2">
